...
<template>
  <div v-if="$q.screen.gt.sm" class="staking-header__top text-right">
  ...
  <div class="staking-header__main row items-end q-py-md">
    <div class="container relative-position">
      <div class="row items-end justify-between full-width">
        ...
        <div v-if="$q.screen.lt.md" class="total-validators-nxs q-mr-auto">
          <validators-total />
        </div>
      ...
      <div v-if="$q.screen.lt.sm" class="row items-center full-width total-validators-xs">
        <div class="q-mt-sm">
